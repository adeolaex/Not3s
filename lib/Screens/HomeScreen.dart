            ...
            child: GestureDetector(
              ...
              child: FloatingActionButton(
                ...
                onPressed: () async {
                  ...
                  // print(Provider.of<UserData>(context, listen: false).imagePathOfEachNote);..TODO
                  setState(() {
                    canBeClicked = canBeClicked + 1;
                  });
                  if (canBeClicked == 1) {
          ...
          child: Material(
            ...
            child: Column(
              ...
              children: [
                SizedBox(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        'Settings',
                        style: TextStyle(color: liltextColor.withOpacity(0.9), fontSize: 23),
                      ),
                      CupertinoButton(
                        padding: EdgeInsets.zero,
                        child: Icon(
                ...
                Theme(
                  data: ThemeData(
                    splashColor: Color(0xFFE1E8ED).withOpacity(0.9),
